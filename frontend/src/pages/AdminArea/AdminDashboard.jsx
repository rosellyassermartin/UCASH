// src/pages/AdminArea/AdminDashboard.jsx
  ...
  return (
    <div className="min-h-screen space-y-5 p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        {/* ── Monthly Revenue Chart (shared component) ─────── */}
        <div className="rounded-3xl border border-white/[0.07] bg-white/[0.02] p-5 backdrop-blur-sm">
          ...
          {/* Same component, same data, same style as AdminReports */}
          <MonthlyRevenueChart
          ...
          <div className="space-y-2">
            {recentStudents.map((s) => (
              ...
              >
                ...
                <p className="font-mono text-xs text-slate-500">{s.student_id}</p>
